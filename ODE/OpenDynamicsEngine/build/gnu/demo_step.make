...
ifeq ($(CONFIG),DebugSingleDLL)
  ...
  OBJDIR := obj/step/DebugSingleDLL
...
ifeq ($(CONFIG),ReleaseSingleDLL)
  ...
  OBJDIR := obj/step/ReleaseSingleDLL
...
ifeq ($(CONFIG),DebugSingleLib)
  ...
  OBJDIR := obj/step/DebugSingleLib
...
ifeq ($(CONFIG),ReleaseSingleLib)
  ...
  OBJDIR := obj/step/ReleaseSingleLib
...
ifeq ($(CONFIG),DebugDoubleDLL)
  ...
  OBJDIR := obj/step/DebugDoubleDLL
...
ifeq ($(CONFIG),ReleaseDoubleDLL)
  ...
  OBJDIR := obj/step/ReleaseDoubleDLL
...
ifeq ($(CONFIG),DebugDoubleLib)
  ...
  OBJDIR := obj/step/DebugDoubleLib
...
ifeq ($(CONFIG),ReleaseDoubleLib)
  ...
  OBJDIR := obj/step/ReleaseDoubleLib
...
$(OBJDIR)/demo_step.o: ../../ode/demo/demo_step.cpp
	-@$(CMD_MKOBJDIR)
	@echo $(notdir $<)
	@$(CXX) $(CXXFLAGS) -o "$@" -c "$<"
