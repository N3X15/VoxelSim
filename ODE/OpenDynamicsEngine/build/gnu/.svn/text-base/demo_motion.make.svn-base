...
ifeq ($(CONFIG),DebugSingleDLL)
  ...
  OBJDIR := obj/motion/DebugSingleDLL
...
ifeq ($(CONFIG),ReleaseSingleDLL)
  ...
  OBJDIR := obj/motion/ReleaseSingleDLL
...
ifeq ($(CONFIG),DebugSingleLib)
  ...
  OBJDIR := obj/motion/DebugSingleLib
...
ifeq ($(CONFIG),ReleaseSingleLib)
  ...
  OBJDIR := obj/motion/ReleaseSingleLib
...
ifeq ($(CONFIG),DebugDoubleDLL)
  ...
  OBJDIR := obj/motion/DebugDoubleDLL
...
ifeq ($(CONFIG),ReleaseDoubleDLL)
  ...
  OBJDIR := obj/motion/ReleaseDoubleDLL
...
ifeq ($(CONFIG),DebugDoubleLib)
  ...
  OBJDIR := obj/motion/DebugDoubleLib
...
ifeq ($(CONFIG),ReleaseDoubleLib)
  ...
  OBJDIR := obj/motion/ReleaseDoubleLib
...
$(OBJDIR)/demo_motion.o: ../../ode/demo/demo_motion.cpp
	-@$(CMD_MKOBJDIR)
	@echo $(notdir $<)
	@$(CXX) $(CXXFLAGS) -o "$@" -c "$<"
