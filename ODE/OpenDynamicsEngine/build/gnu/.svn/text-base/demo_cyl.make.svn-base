...
ifeq ($(CONFIG),ReleaseSingleDLL)
  ...
  OBJDIR := obj/cyl/ReleaseSingleDLL
...
ifeq ($(CONFIG),ReleaseSingleLib)
  ...
  OBJDIR := obj/cyl/ReleaseSingleLib
...
ifeq ($(CONFIG),ReleaseDoubleDLL)
  ...
  OBJDIR := obj/cyl/ReleaseDoubleDLL
...
ifeq ($(CONFIG),ReleaseDoubleLib)
  ...
  OBJDIR := obj/cyl/ReleaseDoubleLib
...
$(OBJDIR)/demo_cyl.o: ../../ode/demo/demo_cyl.cpp
	-@$(CMD_MKOBJDIR)
	@echo $(notdir $<)
	@$(CXX) $(CXXFLAGS) -o "$@" -c "$<"
