...
ifeq ($(CONFIG),DebugSingleDLL)
  ...
  OBJDIR := obj/crash/DebugSingleDLL
...
ifeq ($(CONFIG),ReleaseSingleDLL)
  ...
  OBJDIR := obj/crash/ReleaseSingleDLL
...
ifeq ($(CONFIG),DebugSingleLib)
  ...
  OBJDIR := obj/crash/DebugSingleLib
...
ifeq ($(CONFIG),ReleaseSingleLib)
  ...
  OBJDIR := obj/crash/ReleaseSingleLib
...
ifeq ($(CONFIG),DebugDoubleDLL)
  ...
  OBJDIR := obj/crash/DebugDoubleDLL
...
ifeq ($(CONFIG),ReleaseDoubleDLL)
  ...
  OBJDIR := obj/crash/ReleaseDoubleDLL
...
ifeq ($(CONFIG),DebugDoubleLib)
  ...
  OBJDIR := obj/crash/DebugDoubleLib
...
ifeq ($(CONFIG),ReleaseDoubleLib)
  ...
  OBJDIR := obj/crash/ReleaseDoubleLib
...
$(OBJDIR)/demo_crash.o: ../../ode/demo/demo_crash.cpp
	-@$(CMD_MKOBJDIR)
	@echo $(notdir $<)
	@$(CXX) $(CXXFLAGS) -o "$@" -c "$<"
