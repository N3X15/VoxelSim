...
ifeq ($(CONFIG),DebugSingleDLL)
  ...
  OBJDIR := obj/jointPU/DebugSingleDLL
...
ifeq ($(CONFIG),ReleaseSingleDLL)
  ...
  OBJDIR := obj/jointPU/ReleaseSingleDLL
...
ifeq ($(CONFIG),DebugSingleLib)
  ...
  OBJDIR := obj/jointPU/DebugSingleLib
...
ifeq ($(CONFIG),ReleaseSingleLib)
  ...
  OBJDIR := obj/jointPU/ReleaseSingleLib
...
ifeq ($(CONFIG),DebugDoubleDLL)
  ...
  OBJDIR := obj/jointPU/DebugDoubleDLL
...
ifeq ($(CONFIG),ReleaseDoubleDLL)
  ...
  OBJDIR := obj/jointPU/ReleaseDoubleDLL
...
ifeq ($(CONFIG),DebugDoubleLib)
  ...
  OBJDIR := obj/jointPU/DebugDoubleLib
...
ifeq ($(CONFIG),ReleaseDoubleLib)
  ...
  OBJDIR := obj/jointPU/ReleaseDoubleLib
...
$(OBJDIR)/demo_jointPU.o: ../../ode/demo/demo_jointPU.cpp
	-@$(CMD_MKOBJDIR)
	@echo $(notdir $<)
	@$(CXX) $(CXXFLAGS) -o "$@" -c "$<"
