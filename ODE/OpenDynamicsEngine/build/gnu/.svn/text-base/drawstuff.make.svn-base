...
ifeq ($(CONFIG),DebugSingleDLL)
  ...
  CPPFLAGS := $(DEPFLAGS) -D "WIN32" -D "DS_DLL" -D "USRDLL" -D "dSINGLE" -I "../../include" -I "../../ode/src"
  ...
  LDDEPS :=
  RESFLAGS := -D "WIN32" -D "DS_DLL" -D "USRDLL" -D "dSINGLE" -I "../../include" -I "../../ode/src"
...
ifeq ($(CONFIG),DebugSingleLib)
  ...
  CPPFLAGS := $(DEPFLAGS) -D "WIN32" -D "DS_LIB" -D "dSINGLE" -I "../../include" -I "../../ode/src"
  CFLAGS += $(CPPFLAGS) $(TARGET_ARCH) -g
  CXXFLAGS += $(CFLAGS)
  LDFLAGS += -L$(BINDIR) -L$(LIBDIR) -luser32 -lopengl32 -lglu32 -lwinmm -lgdi32
  LDDEPS :=
  RESFLAGS := -D "WIN32" -D "DS_LIB" -D "dSINGLE" -I "../../include" -I "../../ode/src"
...
ifeq ($(CONFIG),DebugDoubleDLL)
  ...
  CPPFLAGS := $(DEPFLAGS) -D "WIN32" -D "DS_DLL" -D "USRDLL" -D "dDOUBLE" -I "../../include" -I "../../ode/src"
  CFLAGS += $(CPPFLAGS) $(TARGET_ARCH) -g
  CXXFLAGS += $(CFLAGS)
...
ifeq ($(CONFIG),DebugDoubleLib)
  ...
  CPPFLAGS := $(DEPFLAGS) -D "WIN32" -D "DS_LIB" -D "dDOUBLE" -I "../../include" -I "../../ode/src"
  CFLAGS += $(CPPFLAGS) $(TARGET_ARCH) -g
  CXXFLAGS += $(CFLAGS)
  LDFLAGS += -L$(BINDIR) -L$(LIBDIR) -luser32 -lopengl32 -lglu32 -lwinmm -lgdi32
  LDDEPS :=
