...
ifeq ($(CONFIG),DebugSingleDLL)
  ...
  OBJDIR := obj/chain1/DebugSingleDLL
...
ifeq ($(CONFIG),ReleaseSingleDLL)
  ...
  OBJDIR := obj/chain1/ReleaseSingleDLL
...
ifeq ($(CONFIG),DebugSingleLib)
  ...
  OBJDIR := obj/chain1/DebugSingleLib
...
ifeq ($(CONFIG),ReleaseSingleLib)
  ...
  OBJDIR := obj/chain1/ReleaseSingleLib
...
ifeq ($(CONFIG),DebugDoubleDLL)
  ...
  OBJDIR := obj/chain1/DebugDoubleDLL
...
ifeq ($(CONFIG),ReleaseDoubleDLL)
  ...
  OBJDIR := obj/chain1/ReleaseDoubleDLL
...
ifeq ($(CONFIG),DebugDoubleLib)
  ...
  OBJDIR := obj/chain1/DebugDoubleLib
...
ifeq ($(CONFIG),ReleaseDoubleLib)
  ...
  OBJDIR := obj/chain1/ReleaseDoubleLib
...
$(OBJDIR)/demo_chain1.o: ../../ode/demo/demo_chain1.c
	-@$(CMD_MKOBJDIR)
	@echo $(notdir $<)
	@$(CC) $(CFLAGS) -o "$@" -c "$<"
